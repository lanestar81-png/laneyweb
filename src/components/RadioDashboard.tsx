...
const FEATURED_UK: Station[] = [
  { id: "f-bbc1",    name: "BBC Radio 1",      url: "https://a.files.bbci.co.uk/ms6/live/3441A116-B12E-4D2F-ACA8-C1984642FA4B/audio/simulcast/hls/nonuk/pc_hd_abr_v2/cf/bbc_radio_one.m3u8",              favicon: GFAV("bbc.co.uk/radio1"),  tags: ["pop","mainstream"],     country: "United Kingdom", countryCode: "GB", language: "english", codec: "HLS", bitrate: 96, clicks: 0 },
