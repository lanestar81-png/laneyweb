...
import {
  ...
  Wind, Train, Gauge, Telescope, Flower2, Satellite, MessagesSquare,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/fire",       label: "Fire Map",          icon: Flame,           color: "text-orange-400"  },
  ...
  { href: "/satellites", label: "Satellites",        icon: Satellite,       color: "text-violet-400"  },
  { href: "/ships",      label: "Ships",             icon: Anchor,          color: "text-blue-400"    },
